...
import cn.linshiyou.financialFinalContest.login.util.ConstantWxPropertiesUtils;
...
//                System.out.println("11");
            ...
            //跳转到前端页面
            return "redirect:" + ConstantWxPropertiesUtils.FINANCIAL_BASE_URL + "/weixin/callback?token="+map.get("token")+ "&openid="+map.get("openid")+ "&nickname="+URLEncoder.encode(map.get("nickname"),"utf-8")+"&name="+URLEncoder.encode(map.get("name"),"utf-8");
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
